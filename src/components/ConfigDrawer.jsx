  ...
  return (
    <div
      ...
      <Show when={show()}>
        ...
        <div className="flex mb-6 items-center justify-center w-full cursor-pointer">
          <label htmlFor="dropzone_onnx_file"
                 draggable
            ...
            <div className="flex flex-col items-center justify-center pt-5 pb-6">
              ...
              <p className="mb-2 text-sm text-gray-500">
                <span className="font-semibold">点击选择</span></p>
              <p className="text-xs text-gray-500">模型文件，支持onnx格式</p>
            </div>
          </label>
          <input id="dropzone_onnx_file" onChange={onChange} type="file" className="hidden" accept=".onnx"/>
        </div>
